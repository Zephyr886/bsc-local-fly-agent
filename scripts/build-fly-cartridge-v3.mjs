// Rebuild the v3 candidate artifact using only this repository's pinned inputs.
...
const name = 'contracts/FlyCartridgeRegistryV3Auto.sol';
const contractName = 'FlyCartridgeRegistryV3Auto';
const target = path.join(root, 'artifacts/fly-cartridge-v3-auto-candidate.json');
...
if (process.argv.includes('--write')) {
  ...
  assert.deepEqual(bytes, fs.readFileSync(target),
    'Candidate artifact differs from pinned source or dependencies');
}
